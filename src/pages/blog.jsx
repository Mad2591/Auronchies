...
import b6 from '../assets/images/blog/irfan.jpg'
import b2 from '../assets/images/blog/shifa.jpg'
import b3 from '../assets/images/blog/tan.jpg'
        ...
        <div className="col-12 p-5">
          ...
          <div className="row g-0">
            <div className="col-md-4">
              <img src={b6} className="img-fluid rounded-start" alt="..." />
            </div>
            <div className="col-md-6">
              <div className="card-body">
                <h5 className="card-title">Sharfaraz Gumnalli</h5>
                <p className="card-text">Junior Front-End & Back-End Developer <br /> </p>
        ...
        <div className="col-12 p-5">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-6">
                    <div className="card-body">
                      <h5 className="card-title">Shifa</h5>
            ...
            <div className="col-12 p-5">
              <div className="card mb-3">
                <div className="row g-0">
                  ...
                  <div className="col-md-6">
                    <div className="card-body">
                      <h5 className="card-title">Taniya</h5>
            ...
            <div className="col-12 p-5">
              <div className="card mb-3">
                <div className="row g-0">
                  <div className="col-md-4">
                    <img src={b1} alt="" className='img-fluid rounded-start' />
                  </div>
                  <div className="col-md-6">
                    <div className="card-body">
